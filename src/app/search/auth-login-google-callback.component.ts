...
@Component({
  ...
  selector: 'auth-login-google-callback',
  template: `
...
export class AuthLoginGoogleCallbackComponent implements OnInit {
  ...
  handleAuthentication() {
    ...
    this.activatedRoute.queryParams
      ...
      .subscribe(res => {
        ...
        // if (window.opener) {
        //
        //   window.opener.postMessage({user, token}, location.origin);
        //   window.close();
        // }
